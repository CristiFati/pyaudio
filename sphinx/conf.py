...
# We use automodule to generate documentation, so pyaudio must be importable,
# i.e., already built and in the PYTHONPATH. We import it here to reference
